...
let proj2Title = document.getElementById("proj1-title");
let proj2desc = document.getElementById("proj1-description");
let proj3Title = document.getElementById("proj1-title");
let proj3desc = document.getElementById("proj1-description");
